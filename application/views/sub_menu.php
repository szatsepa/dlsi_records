        ...
        if($controller_name === '404'){
            ...
            switch ($controller_name) {
                case 'order':                   
                    ...
                    break;
                case 'math':
                    $sub_menu = array('math/pif'=>'Теорема Піфагора','math/sin'=>'Теорема сінусів','math/strop'=>'Розрахунок 2-о скатної стропильної системи','math/strop/quadro'=>'Розрахунок 4-х скатної стропильної системи','math/power'=>'Мощность 3-ф','math'=>'Тригонометрия',);
                    break;
                case 'staff':
                ...
                case 'pay':                   
                    ...
                    break;
                case 'produce':
                    $sub_menu = array('produce'=>'Склад','produce/equipment'=>'Оборудование','produce/expendables'=>'Розхідні матеріали','produce/nomenclature'=>'Номенклатура','produce/category'=>'Типы продукции','produce/account'=>'Гроші під звіт');
                    break;
                case 'sale':
