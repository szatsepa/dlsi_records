$(document).ready(function(){
    ...
    $("#save").live('click',function(){
        ...
        _save("work/add", "INSERT INTO `function` (`function`) VALUES ('"+$("#function").val()+"')");

    }).css({"cursor":"pointer"});

    $("#edit").live('click',function(){
        
        _save("work/update", "UPDATE `function` SET `function`='"+$("#function").val()+"'  WHERE `id`="+$("#uid").val());
...
//              // console.log(id);  
          _save("work/update", "UPDATE function SET activity = 0 WHERE id = "+id);
        }
    });
